    ...
    ui(new Ui::Form)
{
    ...
    ui->label->setPixmap(background.scaled(this->size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
    ...
    landMarkInfo[1] = "This architectural feature also allowed cool air from the Venturi effect to pass through, thus making the whole "
                      "\narea more pleasant during the high temperatures in summer. This amazing ventilation that the palace enjoys is the "
                      "\nreason why it was named as the Hawa Mahal, which literally translates into the “Palace of the Winds”. It is the tallest "
                      "\nbuilding in the world that has been built without a foundation. It has a curved architecture that leans at an 87-degree angle, "
    ...
    restaurantInfo[0] = "\nPani Puri is a famous snack in India which is a  deep-fried breaded sphere filled with a mixture of spicy water, "
    ...
    restaurantInfo[2] = "\nBiryani is a mixed rice dish which is very popular in India. It is made with rice, some type of meat (chicken, beef, goat, lamb, prawn, or fish) "
